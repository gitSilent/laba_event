...
function calculatator(){
    ...
    str = document.createElement('output');
    ...
    strDiv.classList.add('strDiv');
    stroka = document.querySelector('.strDiv');
    CalcDiv.appendChild(strDiv);
    strDiv.appendChild(str)
    ...
    divZeroClear = document.createElement('div');
    divZeroClear.classList.add('divZeroClear');
    CalcDiv.append(divZeroClear);
    CalcZeroClear = document.querySelector('.divZeroClear');
    
    divRes = document.createElement('div');
    divRes.classList.add('divRes');
    CalcDiv.append(divRes);
    CalcRes = document.querySelector('.divRes');
